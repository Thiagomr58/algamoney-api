...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Como não existe um metodo implementda de EmptyResultDataAccessException, eu crio o meu metodo e atrvés do @ExceptionHandler eu posso passar uma lista com todas as excessoes que meu metodo ira tratar
    @ExceptionHandler({EmptyResultDataAccessException.class})
    // Como o user mandou um codigo que não existe, o metodo retorna um httpStatus 404 Not_Found
