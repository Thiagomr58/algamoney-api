...
INSERT INTO  pessoa (nome, ativo, logradouro, numero, complemento, bairro, cep, cidade, estado) values
    ('Thiago Medeiros', true, 'Almirante Barroso', '987', 'Centro', 'Marco', '66.093-020', 'Belém', 'Pará');

INSERT INTO  pessoa (nome, ativo, logradouro, numero, complemento, bairro, cep, cidade, estado) values
('Miguel Medeiros', true, null, '987', 'Centro', null, '66.093-020', 'Belém', 'Pará');

INSERT INTO  pessoa (nome, ativo, logradouro, numero, complemento, bairro, cep, cidade, estado) values
('Geice Rodrigues', true, 'Rua dos Timbiras', '1224', 'Centro', 'Batista Campos', '66.093-020', 'Belém', 'Pará');
